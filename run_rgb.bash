...
t. ! queue ! "video/x-raw(memory:NVMM),width=2560,height=1440,framerate=40/1" ! nvvidconv flip-method=2 ! nvv4l2h264enc bitrate=20000000 ! h264parse ! mp4mux ! filesink location="$OUTPUT"_rgb.mp4 \
